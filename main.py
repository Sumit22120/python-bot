...
PAYMENT_CHANNEL = "@rddsfsd5" #add payment channel here including the '@' sign
OWNER_ID = 6905107108 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@referandearn143owee"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 

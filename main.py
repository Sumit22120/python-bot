...
BOT_TOKEN = "8163270160:AAF7Ex8y-uQcJipDsUjP96W0ns2MaT2J3Ho"
PAYMENT_CHANNEL = "@Referandearnpayment1616" #add payment channel here including the '@' sign
OWNER_ID = 6905107108 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@referandearn143owee", "@hackersellertraderlife"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
